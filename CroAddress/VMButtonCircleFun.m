...
-(CGRect)getImageIconFrame{
    return self.imgIcon.frame;
}
...
#pragma mark - Provate Instance methods


-(void)addCirclrLayerWithType:(NSInteger)type{
    CGFloat radius;
